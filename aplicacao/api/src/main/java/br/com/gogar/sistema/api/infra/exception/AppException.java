package br.com.gogar.sistema.api.infra.exception;
...
public class AppException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity newExceptionHandlerFeign(Exception e){
        return new ResponseEntity("Verique o cnpj fornecido.", HttpStatus.INTERNAL_SERVER_ERROR);
    }
